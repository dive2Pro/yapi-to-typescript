...
exports.default = (function (config) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var apiCollection, categoryIdToApiList, tsContent, targetFile, requestFile;
    var _this = this;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                consola_1.default.info('获取接口 JSON 文件中...');
                return [4 /*yield*/, fetchApiCollection_1.default(config)];
            case 1:
                ...
                return [4 /*yield*/, Promise.all(Object.keys(config.categories).map(function (categoryId) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                        var _a, getRequestFunctionName, getInterfaceName;
                        var _this = this;
                        return tslib_1.__generator(this, function (_b) {
                            _a = config.categories[categoryId], getRequestFunctionName = _a.getRequestFunctionName, getInterfaceName = _a.getInterfaceName;
                                    ...
                                    return tslib_1.__generator(this, function (_a) {
                                        switch (_a.label) {
                                            ...
                                            case 1:
                                                ...
                                                return [4 /*yield*/, generateResponsePayloadType_1.default(api, responseDataInterfaceName, config.dataKey)];
                                            case 2:
                                                ...
                                                return [2 /*return*/, [
                                                        ...
                                                        "/**\n * " + api.title + "\n */\nexport function " + getRequestFunctionName(extendedApi) + "(requestData" + (/(\{\}|any)$/s.test(requestPayloadType) ? '?' : '') + ": " + requestDataInterfaceName + "): Promise<" + responseDataInterfaceName + "> {\n" + [
                                                            ...
                                                            "    path: '" + api.path + "',",
                                                            "    method: '" + api.method + "',",
                                                            "    requestBodyType: '" + (api.method === types_1.Method.GET ? types_1.RequestBodyType.Query : api.req_body_type) + "',",
            ...
            case 2:
                tsContent = (_a.sent())
                    ...
                    .join('\n\n');
                targetFile = path_1.default.resolve(process.cwd(), config.targetFile);
