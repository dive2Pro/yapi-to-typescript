...
/** API 列表 */
export declare type ApiList = Api[];
/** API 集合，对应数据导出的 json 内容 */
export declare type ApiCollection = Array<{
    /** 分类名称 */
    name: string;
    /** 分类备注 */
    desc: string;
...
/** 请求，应返回包含结果的 Promise */
export declare type Request = (payload: RequestPayload) => Promise<any>;
/** 扩展 API */
export declare type ExtendedApi = Api & {
