                                                        ...
                                                        switch (_a.label) {
                                                            ...
                                                            case 2:
                                                                ...
                                                                return [2 /*return*/, [
                                                                        "/**\n * **\u8BF7\u6C42\u7C7B\u578B**\uFF1A" + api.title + "\n */\n" + requestPayloadType,
                                                                        "/**\n * **\u54CD\u5E94\u7C7B\u578B**\uFF1A" + api.title + "\n */\n" + responsePayloadType,
                                                                        "/**\n * " + api.title + "\n */\nexport function " + getRequestFunctionName(extendedApi) + "(requestData" + (/(\{\}|any)$/s.test(requestPayloadType) ? "?" : "") + ": " + requestDataInterfaceName + ", option: Options): Promise<" + responseDataInterfaceName + "> {\n" + [
