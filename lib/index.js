...
exports.default = (config) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    config.project.forEach((projectConfig) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        tsContent = (yield Promise.all(categories.map((categoryId) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            return Promise.all((categoryIdToApiList[categoryId] || []).map((api) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
                const extendedApi = Object.assign(Object.assign({}, api), { parsedPath: path_1.default.parse(api.path), changeCase: changeCase });
