                    ...
                    return tslib_1.__generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, Promise.all(Object.keys(projectConfig.categories).map(function (categoryId) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                        var _a, getRequestFunctionName, getInterfaceName;
                                        var _this = this;
                                        return tslib_1.__generator(this, function (_b) {
                                            _a = projectConfig.categories[categoryId], getRequestFunctionName = _a.getRequestFunctionName, getInterfaceName = _a.getInterfaceName;
